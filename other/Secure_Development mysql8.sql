...
--
CREATE DATABASE IF NOT EXISTS `secure_development` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
CREATE TABLE `news` (
  `id` int(1) NOT NULL,
  `username` mediumtext COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `xssblind` (
  ...
  `name` mediumtext COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
